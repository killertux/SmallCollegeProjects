...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, modkey }, "p", function() os.execute("screenshot") end,
    ...
    awful.key({ altkey, modkey }, "Left", function () lain.util.tag_view_nonempty(-1) end,
              {description = "view  previous nonempty", group = "tag"}),
    awful.key({ altkey, modkey
     }, "Right", function () lain.util.tag_view_nonempty(1) end,
              {description = "view  previous nonempty", group = "tag"}),
    ...
    -- Widgets popups
    awful.key({ altkey, modkey }, "c", function () lain.widget.calendar.show(7) end,
